# Comparativa final — nueve Case Projects

## Propósito
Comparar los nueve casos realizados para identificar qué tipo de señal aporta cada uno, en qué condiciones Codex rinde mejor y qué hipótesis conviene probar a continuación.
...
### Qué señal aportó
`hexagonal-architecture-python-case` añade una señal especialmente útil porque combina varios elementos a la vez:
...
Este caso añade un matiz metodológico importante:
...
## Diferencias clave entre los nueve casos
...
En los nueve casos, Codex rindió mejor cuando se mantuvieron estas condiciones:
...
- También hay evidencia de que la gobernanza del experimento importa: no toda fricción merece una PR adicional, no toda “solución local” debe mergearse si el runtime está fuera de contrato, y no toda PR4 mínima implica green completo del comando estándar.
...
## Conclusión
Los nueve casos, en conjunto, sugieren que Codex funciona bien en cambios pequeños, acotados, reversibles y bien revisados.

La evidencia acumulada es especialmente sólida en nueve planos:
...
No seguir por inercia en ninguno de estos nueve repositorios.

La siguiente hipótesis debería subir un nivel y probar esto:

**Codex puede sostener criterio conservador en una ruta profunda con varias capas internas cuando dos o tres alternativas pequeñas realmente competitivas siguen siendo plausibles hasta la fase técnica, y puede cerrarla con buena gobernanza experimental sin perder disciplina de PR pequeña ni claridad de validación, incluso distinguiendo correctamente entre validación focalizada suficiente y green completo del runner estándar.**
...
## Distinción metodológica crítica (PR4 y validación)
Para evitar ambigüedad en los siguientes casos, conviene separar explícitamente tres planos:
- **PR4 mínima viable**: cambio de entorno estrictamente local, de una sola intención y con beneficio directo sobre la prueba objetivo del caso.
- **Validación focalizada suficiente**: evidencia de que la hipótesis del caso queda cubierta por tests concretos del hotspot, aunque el runner completo no esté en verde.
- **Green completo del runner estándar**: estado global del repositorio, deseable pero no siempre necesario para cerrar una hipótesis local cuando el alcance acordado es más estrecho.

Regla operativa sugerida:
- ejecutar PR4 solo si el coste es local y no abre frente amplio;
- cerrar con validación focalizada cuando esa evidencia sea suficiente para la hipótesis;
- tratar el green completo como objetivo de normalización del repo, no como condición automática para cada caso experimental acotado.
